...
sys.path.append('./')
from data_utils_local import get_DE_genes, get_dropout_non_zero_genes, DataSplitter
from utils_local import print_sys, zip_data_download_wrapper, dataverse_download,\
...
class PertData:
    ...
    def prepare_split(self, split = 'simulation', 
        ...
        if os.path.exists(split_path):
            ...
            sys.path.append('/content/drive/MyDrive/gears_local')
            from data_utils_local import DataSplitter
